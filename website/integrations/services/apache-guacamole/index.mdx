...
- [Providing Guacamole with a custom username set in Authentik user's attributes](https://dae.me/blog/2705/authentik-custom-username-oauth-apache-guacamole-property-mapping/).
